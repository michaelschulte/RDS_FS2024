...
- Fragestellung abgeben (Frage + grobe Skizze wie du die Frage beantworten willst, via email an: <a href="mailto:michael.schulte@unibe.ch">michael.schulte@unibe.ch</a> abgeben (**28.03.24**, 12.00 Uhr (high noon))
...
- Kurze R-Markdown Präsentation (max 10 Slides)erstellen, in der die Daten erklärt, die Fage präsentiert und dann die Antwort(en) erläutert werden. 
- Präsentation im Kurs vorstellen (**10.04.24**)
- Code + Markdown Präsentation abgeben (**09.04.24**, high noon)
...
3. Fragestellung abgeben (Frage + grobe Skizze wie du die Frage beantworten willst, via email an: <a href="mailto:michael.schulte@unibe.ch">michael.schulte@unibe.ch</a> abgeben (**28.03.24**, 12.00 Uhr (high noon))
...
4. *Maximal Anzahl Slides 10!*

5. Abgabe via regulärem <a href = 'https://www.dropbox.com/request/H8dN3B8vm81zifcTjovP'>Practicals Upload Link</a>!
