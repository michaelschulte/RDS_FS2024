...
10. Erstelle im nächsten Schritt der Pipeline erneut eine Variable `termin_eingehalten_01` genauso wie du das vorher bereits einmal gemacht hast. Erstelle ausserdem eine Variable `niederschlag_01` die anzeigt, ob es Niederschlag gab oder nicht. 
